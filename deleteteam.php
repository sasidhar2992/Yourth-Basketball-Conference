...
<p style= "text-align:center; font-family:Georgia; color:Green; font-size:24px">&nbsp&nbsp&nbsp&nbsp<b>Delete Team</b>
<p style="text-align:center;">select the Team.id:</p>
<?php 
...
//it is coming from a dropdown that is pulled from the db
 //just to demonstrate
$q = "delete from Teams where Team_id='$own'";
