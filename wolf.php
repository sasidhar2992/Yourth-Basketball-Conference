<html>
    ...
    <td class="links"><table width="100%" height="5%">
      <tr bgcolor="LightGrey">
		...
		<marquee behavior="ALTERNATE" bgcolor="White"><a href="wolf.php"><img src="wolf.jpg" width="50" height="50" alt="WolfClan" /></a></marquee><br><br><br>
<p style="font-family:Georgia;font-size:25px;color:Green;text-align:center"><b>WolfClans</b></p><br>
...
<?php
        ...
        $query = "select * from Coach where Team_id='WLF'";
...
<?php
        ...
        or die ('Could not connect to MySql:' .mysqli_connect_error() );
        mysqli_set_charset($dbconnection, 'utf8');
        $query = "select * from Players where Team_id='WLF'";
        $result = mysqli_query ($dbconnection, $query);
		if (mysqli_num_rows($result) > 0) 
        {
