...
<p style="font-family:Georgia;font-size:25px;color:Green;text-align:center"><b>Referees</b></p>
<?php
        ...
        $query = "select * from Referee";//data is displayed  based on the query//
