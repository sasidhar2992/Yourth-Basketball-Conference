...
<p style= "text-align:center; font-family:Georgia; color:Green; font-size:24px">&nbsp&nbsp&nbsp&nbsp<b>Delete Referee</b>
<p style="text-align:center;">select the Referee.id:</p>
<?php 
...
//define the query
$q = "select Referee_id from Referee ";
//run the query
...
//it is coming from a dropdown that is pulled from the db
 //just to demonstrate
$q = "delete from Referee where Referee_id='$own'";
