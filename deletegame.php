...
<p style= "text-align:center; font-family:Georgia; color:Green; font-size:24px">&nbsp&nbsp&nbsp&nbsp<b>Delete Games</b>
<p style="text-align:center;">select the Game number:</p>
<?php 
...
//define the query
$q = "select Game_number from Games ";
//run the query
...
//it is coming from a dropdown that is pulled from the db
 //just to demonstrate
$q = "delete from Games where Game_number='$own'";
