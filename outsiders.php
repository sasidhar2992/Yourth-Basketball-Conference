<html>
    ...
    <td class="links"><table width="100%" height="5%">
      <tr bgcolor="LightGrey">
		...
		<marquee behavior="ALTERNATE" bgcolor="White"><a href="outsiders.php"><img src="outsiders.jpg" width="50" height="50" alt="outsiders" /></a></marquee><br><br><br>
<p style="font-family:Georgia;font-size:25px;color:Green;text-align:center"><b>Outsiders</b></p><br>
...
<?php
        ...
        $query = "select * from Coach where Team_id='OUS'";//data is displayed  based on the query//
...
<?php
        ...
        or die ('Could not connect to MySql:' .mysqli_connect_error() );
        mysqli_set_charset($dbconnection, 'utf8');
        $query = "select * from Players where Team_id='OUS'";//data is displayed  based on the query//
        $result = mysqli_query ($dbconnection, $query);
		if (mysqli_num_rows($result) > 0) 
        {
