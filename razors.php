<html>
    ...
    <td class="links"><table width="100%" height="5%">
      <tr bgcolor="LightGrey">
		...
		<marquee behavior="ALTERNATE" bgcolor="White"><a href="razors.php"><img src="razor.png" width="50" height="50" alt="razors" /></a></marquee><br><br><br>
<p style="font-family:Georgia;font-size:25px;color:Green;text-align:center"><b>Razors</b></p><br>
...
<?php
        ...
        $query = "select * from Coach where Team_id='RAZ'";//data is displayed  based on the query//
...
<?php
        ...
        or die ('Could not connect to MySql:' .mysqli_connect_error() );
        mysqli_set_charset($dbconnection, 'utf8');
        $query = "select * from Players where Team_id='RAZ'";//data is displayed  based on the query//
        $result = mysqli_query ($dbconnection, $query);
		if (mysqli_num_rows($result) > 0) 
        {
